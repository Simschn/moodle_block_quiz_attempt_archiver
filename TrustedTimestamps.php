...
class TrustedTimestamps
{
     ...
     */
    public static function createRequestfile ($filepath)
    {
        $outfilepath = self::createTempFile();
        $cmd = "openssl ts -query -data ".escapeshellarg($filepath)." -cert -sha512 -no_nonce -out ".escapeshellarg($outfilepath);
